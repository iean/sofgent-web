         ...
         <div className="mx-auto theme-container">
            <div className="grid gap-10 xl:grid-cols-[0.9fr_1.1fr]">
               <div className="max-w-2xl">
                  <SectionHeader
                     eyebrow="Why SofGent"
                     title="Built for companies that want AI-ready systems, not another generic data project"
                     description="SofGent approaches data engineering as part of an AI product strategy. The goal is not just cleaner tables. The goal is a usable infrastructure layer the business can build on."
                     theme="dark"
                  />
                  <div className="mt-8">
                     <Button
