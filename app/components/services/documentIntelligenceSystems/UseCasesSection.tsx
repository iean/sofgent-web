   ...
   return (
      <section className="py-16 md:py-24">
         <div className="mx-auto theme-container">
            <SectionHeader
               eyebrow="Use Cases"
               title="Where document intelligence creates the most leverage"
               description="OCR and AI extraction become valuable when they remove repetitive work from high-volume operational document flows."
            />
