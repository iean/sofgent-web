      ...
      <section className="bg-[linear-gradient(180deg,#f8fafc_0%,#eef3f7_100%)] py-16 md:py-24">
         <div className="mx-auto theme-container">
            <SectionHeader
               ...
               title="The outputs your business can plug into real workflows"
               description="We deliver more than extracted text. The result is a usable system layer for documents, data, and downstream actions."
            />
