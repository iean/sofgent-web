   ...
   return (
      <li className="flex w-full md:w-auto items-center">
         <Link
            href={href}
            aria-label={text}
            className="flex w-full md:w-auto space-x-2.5 items-center text-primary font-medium px-5 py-3 bg-main-gray border border-gray leading-none rounded-full hover:text-primary hover:border-primary common-transition"
         >
