...
| `SPEC-WLR-002` | Crawlability and Metadata Reliability | `Done` | `Critical` |
| `SPEC-WLR-003` | Trust and Claim Substantiation | `Queued` | `High` |
| `SPEC-WLR-004` | Contact Conversion Hardening | `Queued` | `High` |
| `SPEC-WLR-005` | Service and Project Metadata Normalization | `Done` | `High` |
...
| `TASK-WLR-003` | `SPEC-WLR-002` | Resolve `/robots.txt` conflict and verify route output | `Done` | `Critical` |
| `TASK-WLR-004` | `SPEC-WLR-002` | Add OG/Twitter images to core marketing routes | `Done` | `High` |
| `TASK-WLR-005` | `SPEC-WLR-005` | Normalize titles and descriptions on service detail pages | `Done` | `High` |
| `TASK-WLR-006` | `SPEC-WLR-005` | Normalize titles and descriptions on project detail pages | `Done` | `High` |
| `TASK-WLR-007` | `SPEC-WLR-003` | Inventory all hard trust claims and classify as prove, soften, or remove | `Done` | `High` |
| `TASK-WLR-008` | `SPEC-WLR-003` | Rewrite unsupported homepage guarantee and comparison language | `Done` | `High` |
